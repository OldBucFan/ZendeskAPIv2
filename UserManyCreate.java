...
public class UserManyCreate {
	...
	public static ArrayList<JobStatus> main(String[] args, ArrayList<User> users) throws IOException {
		...
		String uriTail = "users/create_many.json";
		...
		for(int i=1;i<=clump;i++){
			...
			String result = PostZendeskData.main(params, payload.toString());
			...
			Gson gson2 = new GsonBuilder()
				...
				.create();
			statuses.add(gson2.fromJson(jobStatusElement, JobStatus.class));
		}
		return statuses;
	}
}
